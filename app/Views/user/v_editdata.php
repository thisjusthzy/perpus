    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <label>Foto</label>
                <img src="<?= base_url('foto/' . $user['foto'])?>" id="gambar_load" class="img-fluid" width="250px" height="250px">
            </div>
        </div>  
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <?php $validation = \Config\Services::validation(); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="nama_user"  placeholder="Nama User" value="<?= $user['nama_user'] ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="no_hp" placeholder="No Handphone" value="<?= $user['no_hp'] ?>">
