            ...
            <?php } ?>
              ...
              ?>
                ...
                <div class="col-sm-12">
                  ...
                  <label>Cover</label>
                    <img src="<?= base_url('cover/' .$buku['cover'])?>" id="gambar_load" class="img-fluid" width="250px" height="250px">
                  </div>
                </div>  
                <div class="col-sm-12">
                  <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="kode_buku"  placeholder="Kode Buku"   value="<?= $buku['kode_buku'] ?>" readonly>
                  ...
                  <div class="form-group">
                    <label>ISBN</label>
                    <input class="form-control" name="isbn" placeholder="ISBN" value="<?= $buku['isbn'] ?>">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <input  class="form-control" name="judul_buku" placeholder="Judul Buku" value="<?= $buku['judul_buku'] ?>">
                  </div>
                </div>
              ...
              <div class="col-sm-3">
                  <div class="form-group">
                    <label>Bahasa</label>
                    <input  class="form-control" name="bahasa" placeholder="Bahasa"  value="<?= $buku['bahasa'] ?>">
                  </div>
                </div>
              ...
              <div class="col-sm-3">
                  <div class="form-group">
                    <label>Halaman</label>
                    <input type="number" class="form-control" name="halaman" placeholder="Halaman" value="<?= $buku['halaman'] ?>">
              ...
              <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="jumlah" placeholder="Jumlah Buku" value="<?= $buku['jumlah'] ?>">
