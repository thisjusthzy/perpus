          ...
          <div class="modal-content">
            ...
            <?php $validation = \Config\Services::validation(); ?>
              ...
              <div class="form-group">
                    ...
                    <input class="form-control <?=  $validation->hasError('nama_rak') ? 'is-invalid' : null?>"  name="nama_rak" placeholder="Nama Rak">
              ...
              <div class="form-group">
                    ...
                    <input type="number" class="form-control  <?=  $validation->hasError('lantai_rak') ? 'is-invalid' : null?> " name="lantai_rak" placeholder="Lantai Rak">
                    <div class="invalid-feedback">
                          <?=$validation->getError('lantai_rak')?>
                    </div>
                  </div>
            </div>
         ...
         <div class="modal-dialog modal-sm">
           <div class="modal-content">
             ...
             <div class="modal-body">
               ...
               <div class="form-group">
                    Apakah anda yakin ingin menghapus <b><?= $value['nama_rak'] ?> Lantai <?= $value['lantai_rak'] ?></b>?
                   </div>
             </div>
             <div class="modal-footer justify-content-between">
               <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
