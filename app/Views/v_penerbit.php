          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <input class="form-control <?=  $validation->hasError('nama_penerbit') ? 'is-invalid' : null?> " name="nama_penerbit" placeholder="Nama Penerbit">
           ...
           <div class="modal-content">
             ...
             <div class="modal-body">
               ...
               <div class="form-group">
                     ...
                     <input class="form-control<?=  $validation->hasError('nama_penerbit') ? 'is-invalid' : null?> " value="<?= $value['nama_penerbit'] ?>" name="nama_penerbit" placeholder="Nama Penerbit">
                     <div class="invalid-feedback">
                           <?=$validation->getError('nama_penerbit')?>
                     </div>
                   </div>
         ...
         <div class="modal-dialog modal-sm">
           <div class="modal-content">
             ...
             <div class="modal-body">
               ...
               <div class="form-group">
                    Apakah anda yakin ingin menghapus <b><?= $value['nama_penerbit'] ?></b>?
                   </div>
             </div>
             <div class="modal-footer justify-content-between">
               <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
