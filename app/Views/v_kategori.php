          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <input class="form-control <?=  $validation->hasError('nama_kategori') ? 'is-invalid' : null?> " name="nama_kategori" placeholder="Nama Kategori">
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    <label>Nama Kategori</label>
                    <input class="form-control<?=  $validation->hasError('nama_kategori') ? 'is-invalid' : null?> " value="<?= $value['nama_kategori'] ?>" name="nama_kategori" placeholder="Nama Kategori">
                    <div class="invalid-feedback">
                          <?=$validation->getError('nama_kategori')?>
                    </div>
                  </div>
