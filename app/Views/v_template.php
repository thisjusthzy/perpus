...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <img src="<?= base_url() ?>" class="brand-image elevation-0">
        <span class="brand-text font-weight-light"><b>PEHA PERPUS</b></span>
      </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Sistem Informasi  Perpustakaan <a href=""></a></strong> Rara M.
  </footer>
</div>
