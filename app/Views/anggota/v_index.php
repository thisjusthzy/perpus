    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('Anggota/AddData')?>" class="btn btn-primary btn-flat btn-sm"> <i class="fas fa-plus"></i> Add </a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-success tn-xs" href="<?= base_url('Anggota/Verifikasi/' . $value['id_anggota'])?>"> Verifikasi Sekarang</a>'
                            <?php } ?>
                        </td>
